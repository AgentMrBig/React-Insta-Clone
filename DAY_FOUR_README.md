...
ANSWER: state-driven views are important to us as software developers because of reduced cognitive load, easier testing and easier visual documentation. A state-driven application is one that is developed considering the possible states the application can have. 
